...
class ArrowsWidget(QWidget):
	def __init__(self, onUp, onDown, onLeft, onRight, onZoomIn, onZoomOut):
		...
		self.zoomin_button.clicked.connect(onZoomIn)
		self.zoomout_button.clicked.connect(onZoomOut)
    
		self.layout: QGridLayout = QGridLayout()
    
		self.layout.addWidget(self.zoomin_button, 0, 0)
		self.layout.addWidget(self.up_button, 0, 1)
		self.layout.addWidget(self.zoomout_button, 0, 2)
